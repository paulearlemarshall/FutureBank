...
export async function seedBaseline(tx: SeedDb, preparedDocuments: PreparedSeedDocument[] = [], now = new Date()): Promise<void> {
  ...
  const caseRows = [
    { customerNumber: "C000001", reference: "KYC-000001", type: "PERIODIC_REVIEW" as const, jurisdiction: "GB", status: "IN_PROGRESS" as const, score: 0, calculated: "LOW" as const, final: null, edd: false, dueAt: timeline.instant(14, 17).toISOString(), submittedAt: null, decidedAt: null, decidedBy: null, comment: null },
