...
export async function seedBaseline(tx: SeedDb, preparedDocuments: PreparedSeedDocument[] = []): Promise<void> {
  ...
  // Keep the baseline pending-payment journey reachable regardless of when the demo is reset.
  const pendingScenarioExpiry = new Date("2099-07-21T09:00:00.000Z");
