  ...
  return (
    <AutomationPage name="customer-detail">
      ...
      <section className="record-banner" data-bp="customer-record-header">
        <div><p>{labelEnum(customer.partyType)} customer · {customer.customerNumber} · <span className="mono" data-bp="customer-rim-number">{customer.rimNumber}</span></p><h1>{customer.displayName}</h1></div>
