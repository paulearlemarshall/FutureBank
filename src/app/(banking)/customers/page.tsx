    ...
    <AutomationPage name="customers">
      ...
      <Panel className="search-panel" title="Search criteria">
        <form action="/customers" method="get" role="search" data-bp="customer-search-form">
          <div className="field"><label htmlFor="customer-search-query">Customer name or number</label><input id="customer-search-query" name="query" data-bp="customer-search-query" defaultValue={query} autoComplete="off" placeholder="e.g. C000001 or Amelia" /></div>
