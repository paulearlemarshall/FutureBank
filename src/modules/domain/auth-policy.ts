...
const permissions: Record<StaffRole, readonly StaffPermission[]> = {
  OPERATOR: ["CUSTOMER_MAINTAIN", "KYC_GATHER", "KYC_SCREEN", "PAYMENT_INITIATE", "PAYMENT_INSTRUCTION_MAINTAIN", "DIRECT_DEBIT_MAINTAIN", "DIRECT_DEBIT_COLLECT", "OVERDRAFT_INITIATE"],
  ...
  ADMIN: ["CUSTOMER_MAINTAIN", "KYC_GATHER", "KYC_SCREEN", "KYC_DECIDE", "RESTRICTION_MAINTAIN", "PAYMENT_INITIATE", "PAYMENT_DECIDE", "PAYMENT_INSTRUCTION_MAINTAIN", "PAYMENT_SCHEDULE_EXECUTE", "DIRECT_DEBIT_MAINTAIN", "DIRECT_DEBIT_COLLECT", "OVERDRAFT_INITIATE", "OVERDRAFT_DECIDE", "OVERDRAFT_ALERT_RESOLVE", "DEMO_RESET"],
};
