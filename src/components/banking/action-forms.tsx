...
function CustomerFields({ customer, state }: { customer?: CustomerDetail; state: ActionState }) {
  return (
    <div className="form-grid">
      ...
      <Field id="customer-given-name" label="Given name"><input id="customer-given-name" name="givenName" data-bp="customer-given-name" defaultValue={customer?.givenName ?? ""} /><ErrorText state={state} name="givenName" /></Field>
      <Field id="customer-family-name" label="Family name"><input id="customer-family-name" name="familyName" data-bp="customer-family-name" defaultValue={customer?.familyName ?? ""} /><ErrorText state={state} name="familyName" /></Field>
      <Field id="customer-legal-name" label="Legal name"><input id="customer-legal-name" name="legalName" data-bp="customer-legal-name" defaultValue={customer?.legalName ?? ""} /><ErrorText state={state} name="legalName" /></Field>
      <Field id="customer-short-name" label="Short name" required><input id="customer-short-name" name="shortName" data-bp="customer-short-name" defaultValue={customer?.shortName ?? ""} required /><ErrorText state={state} name="shortName" /></Field>
      <Field id="customer-date-of-birth" label="Date of birth"><input id="customer-date-of-birth" name="dateOfBirth" data-bp="customer-date-of-birth" type="date" defaultValue={customer?.dateOfBirth ?? ""} /></Field>
      <Field id="customer-registration-number" label="Registration number"><input id="customer-registration-number" name="registrationNumber" data-bp="customer-registration-number" defaultValue={customer?.registrationNumber ?? ""} /></Field>
      <Field id="customer-nationality" label="Nationality" required><input id="customer-nationality" name="nationality" data-bp="customer-nationality" defaultValue={customer?.nationality ?? "GB"} required /></Field>
      <Field id="customer-residence-country" label="Residence country" required><input id="customer-residence-country" name="residenceCountry" data-bp="customer-residence-country" defaultValue={customer?.residenceCountry ?? "GB"} required /></Field>
      <Field id="customer-language" label="Language" required><input id="customer-language" name="language" data-bp="customer-language" defaultValue={customer?.language ?? "English"} required /></Field>
      <Field id="customer-industry" label="Industry" required><input id="customer-industry" name="industry" data-bp="customer-industry" defaultValue={customer?.industry ?? ""} required /></Field>
      <Field id="customer-sector" label="Sector" required><input id="customer-sector" name="sector" data-bp="customer-sector" defaultValue={customer?.sector ?? "Personal Banking"} required /></Field>
      ...
      <Field id="customer-kyc-review-date" label="Next KYC review" required><input id="customer-kyc-review-date" name="kycReviewDate" data-bp="customer-kyc-review-date" type="date" defaultValue={customer?.kycReviewDate ?? "2027-07-19"} required /></Field>
      <Field id="customer-tax-id" label="Tax ID" required><input id="customer-tax-id" name="taxId" data-bp="customer-tax-id" defaultValue={customer?.taxId ?? ""} required /></Field>
      ...
      <Field id="customer-relationship-manager" label="Relationship manager" required><input id="customer-relationship-manager" name="relationshipManager" data-bp="customer-relationship-manager" defaultValue={customer?.relationshipManager ?? "Sofia Bennett"} required /></Field>
      <Field id="customer-address-line1" label="Address line 1" required><input id="customer-address-line1" name="addressLine1" data-bp="customer-address-line1" defaultValue={customer?.addresses[0]?.line1 ?? ""} required /></Field>
      <Field id="customer-city" label="City" required><input id="customer-city" name="city" data-bp="customer-city" defaultValue={customer?.addresses[0]?.city ?? ""} required /></Field>
      <Field id="customer-postal-code" label="Postal code" required><input id="customer-postal-code" name="postalCode" data-bp="customer-postal-code" defaultValue={customer?.addresses[0]?.postalCode ?? ""} required /></Field>
      <Field id="customer-address-country" label="Address country" required><input id="customer-address-country" name="country" data-bp="customer-address-country" defaultValue={customer?.addresses[0]?.country ?? customer?.residenceCountry ?? "GB"} required /></Field>
      <Field id="customer-email" label="Email address" required><input id="customer-email" name="email" data-bp="customer-email" type="email" defaultValue={customer?.contacts.find((item) => item.type === "EMAIL")?.value ?? ""} required /></Field>
      <Field id="customer-phone" label="Phone number" required><input id="customer-phone" name="phone" data-bp="customer-phone" type="tel" defaultValue={customer?.contacts.find((item) => item.type === "MOBILE")?.value ?? ""} required /></Field>
      {!customer ? <>
        ...
        <Field id="customer-identity-number" label="Identity document number" hint="Use fictional data only."><input id="customer-identity-number" name="identityDocumentNumber" data-bp="customer-identity-number" autoComplete="off" /><ErrorText state={state} name="identityDocumentNumber" /></Field>
        <Field id="customer-identity-country" label="Issuing country"><input id="customer-identity-country" name="identityIssuingCountry" data-bp="customer-identity-country" maxLength={2} /></Field>
