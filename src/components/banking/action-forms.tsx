...
function CustomerFields({ customer, state }: { customer?: CustomerDetail; state: ActionState }) {
  return (
    <div className="form-grid">
      ...
      <Field id="customer-kyc-status" label="KYC status" required><select id="customer-kyc-status" name="kycStatus" data-bp="customer-kyc-status" defaultValue={customer?.kycStatus ?? "REVIEW"}><option value="COMPLETE">Complete</option><option value="DUE">Due</option><option value="REVIEW">In review</option></select></Field>
