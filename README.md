...
FutureBank Core is a fictional core-banking application for Blue Prism demonstrations. It provides a deliberately conventional, desktop-first interface, stable automation selectors, persistent Neon Postgres data, and realistic KYC, maker-checker, arranged-overdraft, payment-hold, future-dated payment, standing-order, direct-debit, payment-reversal, end-of-day charge and interest, clearing-reconciliation, customer, account, CSV statement, and audit workflows.
